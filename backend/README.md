...
## setup
it is recommended that you replace every `github.com/akramboussanni/kimono` to your package name. mailing needs to be configured (see section below)

kimono template supports a .env file to load env vars from.
