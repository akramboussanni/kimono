...
type AuthRequest struct {
	Origin int64 `json:"origin,string" example:"1" binding:"required" description:"Issuer of the request (the project ID of the app that is requesting the login)"`
	App    int64 `json:"app,string" example:"1" binding:"required" description:"ID of the app that is requesting the login"`
}
