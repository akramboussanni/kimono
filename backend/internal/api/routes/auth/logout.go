...
import (
	...
	"github.com/akramboussanni/kimono/internal/api"
	"github.com/akramboussanni/kimono/internal/applog"
	"github.com/akramboussanni/kimono/internal/middleware"
...
func (ar *AuthRouter) HandleLogoutEverywhere(w http.ResponseWriter, r *http.Request) {
	...
	err := ar.UserRepo.ChangeSecurityStamp(r.Context(), claims.UserID, utils.GenerateSnowflakeID())
